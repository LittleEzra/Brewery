...
import net.feliscape.hops_and_barrels.content.entity.client.ModModelLayers;
import net.feliscape.hops_and_barrels.registry.ModParticles;
import net.feliscape.hops_and_barrels.client.particle.custom.TreasureParticle;
