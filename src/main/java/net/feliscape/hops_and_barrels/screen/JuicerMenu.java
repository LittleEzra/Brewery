...
public class JuicerMenu extends AbstractContainerMenu {
    ...
    public JuicerMenu(int pContainerId, Inventory inv, BlockEntity entity){
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            for(int slotY = 0; slotY < 3; ++slotY) {
                for(int slotX = 0; slotX < 3; ++slotX) {
                    this.addSlot(new SlotItemHandler(iItemHandler, slotX + slotY * 3, 62 + slotX * 18, 9 + slotY * 18){
                        @Override
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, 9, 80, 74){ // Result Slot
                @Override
                public boolean mayPlace(@NotNull ItemStack stack) {
                    return false;
                }
    ...
    public boolean hasIngredients(){
        return blockEntity.hasIngredients();
    }
