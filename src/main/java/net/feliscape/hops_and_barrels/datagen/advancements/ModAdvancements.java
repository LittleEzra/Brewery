package net.feliscape.hops_and_barrels.datagen.advancements;

import net.feliscape.hops_and_barrels.Brewery;
import net.feliscape.hops_and_barrels.advancements.ModAdvancement;
import net.feliscape.hops_and_barrels.advancements.criterion.LethalBulwarkProtectionTrigger;
