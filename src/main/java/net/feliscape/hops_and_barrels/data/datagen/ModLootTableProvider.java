...
import net.feliscape.hops_and_barrels.data.datagen.loot.ModBlockLootTables;
import net.feliscape.hops_and_barrels.data.datagen.loot.ModBuiltInLootTables;
import net.feliscape.hops_and_barrels.data.datagen.loot.ModPiracyLootTables;
import net.feliscape.hops_and_barrels.data.datagen.loot.ModEntityLootTables;
