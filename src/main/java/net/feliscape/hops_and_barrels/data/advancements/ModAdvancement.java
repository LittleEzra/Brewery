package net.feliscape.hops_and_barrels.data.advancements;

import net.feliscape.hops_and_barrels.Brewery;
import net.feliscape.hops_and_barrels.data.datagen.advancements.ModAdvancements;
...
public class ModAdvancement {
    ...
    static final ResourceLocation BACKGROUND = Brewery.asResource("textures/gui/advancements.png");
    static final String LANG = "advancement." + Brewery.MOD_ID + ".";
    ...
    public boolean isAlreadyAwardedTo(Player player) {
        ...
        Advancement advancement = sp.getServer()
                .getAdvancements()
                .getAdvancement(Brewery.asResource(id));
        if (advancement == null)
            return true;
    ...
    public void save(Consumer<Advancement> t) {
        ...
        datagenResult = builder.save(t, Brewery.asResource(id)
                .toString());
    }
